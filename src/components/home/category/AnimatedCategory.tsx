        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <p className="text-sm text-white/60">
              {categories[active].count} Products
            </p>
            <motion.p className="text-lg text-white/80 mt-8">
              {categories[active].description ? (
                ...
                <span>
                  ...
                  {categories[active].name.toLowerCase()}
                </span>
              )}
            </motion.p>
          </motion.div>
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-10 w-10 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center group/button hover:bg-white/20 transition-all duration-300"
            >
